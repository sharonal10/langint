...
class Embeddings(nn.Module):
    def __init__(self, num_placeholder_words: int, initializer_word: Optional[str], num_placeholder_groups: int = 2, shared_tokens=0, gt_init=0, straight_through=False, start_temp=100.0, kld_scale=5e-4, anneal_func='cosine', blip_guidance=-1, fruit_blip_coeff=0, color_blip_coeff=0):
        super().__init__()
        ...
        num_placeholder_words = 84 #hardcoded to match old training dataset for purposes of loading checkpoint
